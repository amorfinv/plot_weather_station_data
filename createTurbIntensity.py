...
column_to_plot = 'WindSpd_{Std}'
range_to_plot = ['2022-01-01','2022-12-31']
figx, figy = 10, 8

plot_titles = {
        'WindSpd_{Std}': 'Average wind speeds',
...
for weather_station, fit_dict in fit_parameters.items():
    ...
    # get filename
    filename = '_'.join([weather_station, plot_title, *range_to_plot]) + '_TI.png'
...
filename = '_'.join(['stationcomparison', plot_title, *range_to_plot]) + '_TI.png'
filename = filename.replace(" ", "").lower()
